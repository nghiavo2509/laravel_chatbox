...
<script type="text/javascript">
    ...
    var pusher = new Pusher('bfafedc8e2cf564bd052', {
        encrypted: true,
        cluster: "ap1"
    });
              ...
              <div class="media">
                <div class="media-left">
                  <div class="media-object">
                    <img src="https://miro.medium.com/max/570/1*EelUYA6BOTNXtuRjSlaqHw.png" class="img-circle" alt="50x50" style="width: 50px; height: 50px;">
                  </div>
                </div>
                <div class="media-body">
                  <strong class="notification-title">`+data.text+`</strong>
